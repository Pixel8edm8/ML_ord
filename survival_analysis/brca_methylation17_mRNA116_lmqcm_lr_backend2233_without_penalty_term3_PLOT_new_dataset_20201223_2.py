#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index=0.6435112319358993 ？ remove log_var[i] seems as no difference.
"""
...
kidtx = pd.read_csv('brca_Surv_data_methylation17_mRNA120_all_lmqcm20201222_0_2times.csv')
...
#    plt.legend(['${lambda0}$','${lambda1}$'], loc='upper right')
    ...
    np.savetxt("hist.history['loss1000_ml_ordCOX20201223_try']_without_penalty_term.csv",hist.history['loss'], delimiter=",")
