#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000,lr=0.0005 c_index=0.7141221920160252？ 无lamda1*lamda2
"""
...
#    out_clinic2=Net(input_dim, 100, 1, 1)
    ...
    learning_rate=0.001
#    lr2=[0.0005,0.0005,0.0004,0.0002,0.0001,0.00005,0.00005,0.00005,0.00005,0.00001,0.00001]
