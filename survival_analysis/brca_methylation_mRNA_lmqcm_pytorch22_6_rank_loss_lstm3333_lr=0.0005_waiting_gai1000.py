#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000,lr=0.0005 c_index=0.6633996279868365? 无lamda1*lamda2
"""
...
#        epoch_loss= loss.item()
        ...
        loss_history2[i] = loss.item()
        if i>500:
            epoch_loss=loss_history2[500]-i/100+(loss_history2[i]-loss_history2[i-1])
        if i<=500:
            epoch_loss=loss_history2[i]-i/100
