#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index=0.5779796823579911 ？ remove log_var[i] seems as no difference.
#only mRNA c-index=0.5900701101731292
#only methlytiion, cindex=0.5487194162254972
"""
...
kidtx = pd.read_csv('brca_Surv_data_methylation_mRNA_all_lmqcm20201222_0_2times.csv')
