#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index= 0.7043926169695235 ？ remove log_var[i] seems as no difference. 
#only: data_mRNA:0.7002432393761625
#only: data_methylation: 0.5142366576048075
"""
...
#    plt.show()
    ...
    np.savetxt("BRCA_methylation_mRNA_without_penalty_term_ml_ordCOX_20201223.csv",hist.history['loss'], delimiter=",")
...
print("BRCA:dataX=data_rna:",c_indices_mlp)
