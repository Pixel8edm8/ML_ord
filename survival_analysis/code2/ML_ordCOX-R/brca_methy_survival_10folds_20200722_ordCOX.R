...
setwd("C:/IJCAI2020/code/ordCOX-multiLOSS")
...
mydata1= read.csv("brca_prediction1204_18lstm2222_epoch400_drop01_resnet.csv",header = F, fill = F, stringsAsFactors=FALSE)
month1=read.csv("brca_ytime_test1204_18lstm2222_epoch400_drop01_resnet.csv",header = F, fill = F, stringsAsFactors=FALSE)
status1=read.csv("brca_ystatus_test1204_18lstm2222_epoch400_drop01_resnet.csv",header = F, fill = F, stringsAsFactors=FALSE)
...
png(filename = "C:/IJCAI2020/code/ordCOX-multiLOSS/Survival_10folds_2020722ordCOX-multiLOSS.png", width = 5.5, height = 5.5,
	units = "cm", res = 300, pointsize = 7)
plot(fit, mark.time=TRUE, xlab = "Months", ylab = "Survival", main=paste("ordCOX-multiLOSS",sep=""), lty = 1:2,
     col = 1:2, cex = 0.5)
grid()
