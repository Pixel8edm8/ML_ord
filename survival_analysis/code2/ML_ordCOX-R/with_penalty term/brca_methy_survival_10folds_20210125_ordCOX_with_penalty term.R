...
png(filename = "C:/ML_ordCOX/survival analysis/code2/ML_ordCOX-R/with_penalty term/Survival_10folds_20210125ML_ordCOX_with_penalty term.png", width = 5.5, height = 5.5,
