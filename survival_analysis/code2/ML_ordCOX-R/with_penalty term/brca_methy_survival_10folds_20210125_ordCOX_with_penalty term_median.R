...
setwd("C:/ML_ordCOX/survival analysis/code2/ML_ordCOX-R/with_penalty term")
...
mydata1= read.csv("brca_prediction1204_18lstm2222_epoch400_drop01_resnet_with_penalty_term.csv",header = F, fill = F, stringsAsFactors=FALSE)
month1=read.csv("brca_ytime_test1204_18lstm2222_epoch400_drop01_resnet_without penalty term.csv",header = F, fill = F, stringsAsFactors=FALSE)
status1=read.csv("brca_ystatus_test1204_18lstm2222_epoch400_drop01_resnet_with penalty term.csv",header = F, fill = F, stringsAsFactors=FALSE)
...
png(filename = "C:/ML_ordCOX/survival analysis/code2/ML_ordCOX-R/with_penalty term/Survival_10folds_20210125ML_ordCOX_with_penalty term_median.png", width = 5.5, height = 5.5,
