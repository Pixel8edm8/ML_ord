#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# x_train+methylation , epoch=500，c_index_lstm=0.6226604020642379
"""
...
#    model=Model(inp, output)
    ...
    hist=model.fit({'gene_input':x_train,'clinic_input':data_methylation_train}, {'main_output': y_train, 'aux_output': y_train}, batch_size = n1, epochs =500)
