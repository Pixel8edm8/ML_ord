#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#  epoch=450，c_index_lstm=0.5602711237772472?
"""
...
#    ytrue_dim=y_train.shape[1]
    input_dim_methylation =data_methylation_train.shape[2]
...
#    out1=Bidirectional(LSTM(55,activation='linear',return_sequences=True,kernel_initializer=glorot_uniform(),kernel_regularizer=l2(reg),activity_regularizer=l2(0.001)), merge_mode='concat')(title_input)
    out_gene=Bidirectional(LSTM(100,activation='tanh',return_sequences=False), merge_mode='concat')(gene_input)
...
#    out_clinic=Bidirectional(LSTM(10))(out21)
    ...
    out222=Dense(20, activation='linear')(com)

    
#    GRU(50, activation='tanh', return_sequences=False)(out1)
    out3=Dropout(0.05)(out222)
...
#    model=Model(inp, output)
    ...
    hist=model.fit({'gene_input':data_mRNA_train,'clinic_input':data_methylation_train}, {'main_output': y_train, 'aux_output': y_train}, batch_size = n1, epochs =450)
