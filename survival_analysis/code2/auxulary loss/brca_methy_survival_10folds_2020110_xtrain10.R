...
setwd("E:/survival/000000DrIsabelle_clinical/mRNA/mRNA_Methylstion/auxulary loss")
...
mydata1= read.csv("brca_prediction1204_10fold_lstm_age_stage.csv",header = F, fill = F, stringsAsFactors=FALSE)
month1=read.csv("brca_ytime_test1204_10fold_lstm_age_stage.csv",header = F, fill = F, stringsAsFactors=FALSE)
status1=read.csv("brca_ystatus_test1204_10fold_lstm_age_stage.csv",header = F, fill = F, stringsAsFactors=FALSE)
mydata_train_median= read.csv("brca_ypred_train_median1204_10fold_lstm_age_stage.csv",header = F, fill = F, stringsAsFactors=FALSE)
# 
...
png(filename = "E:/survival/000000DrIsabelle_clinical/mRNA/mRNA_Methylstion/auxulary loss/Survival_10folds_2020110.png", width = 5.5, height = 5.5,
