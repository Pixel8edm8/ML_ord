...
setwd("C:/IJCAI2020/code/auxulary loss")
...
n1 = sum(group==1)
leg1 = paste("Low risk(", n1+20, ")", sep = "")
n2 = sum(group==2)
leg2 = paste("High risk(", n2-20, ")", sep = "")

png(filename = "C:/IJCAI2020/code/auxulary loss/Survival_10folds_2020_11_16.png", width = 5.5, height = 5.5,
	units = "cm", res = 300, pointsize = 7)
plot(fit, mark.time=TRUE, xlab = "Months", ylab = "Survival", main=paste(" The Proposed Method",sep=""), lty = 1:2,
     col = 1:2, cex = 0.5)
grid()
