...
setwd("E:/download/2019819Keras-Cox-Model-master/Keras-Cox-Model-master/keras_coxph_brca2019828_12fold6_one")
...
mydata1= read.csv("brca_prediction829_12.csv",header = F, fill = F, stringsAsFactors=FALSE)
month1=read.csv("brca_ytime_test829_12.csv",header = F, fill = F, stringsAsFactors=FALSE)
status1=read.csv("brca_ystatus_test829_12.csv",header = F, fill = F, stringsAsFactors=FALSE)
...
png(filename = "E:/download/2019819Keras-Cox-Model-master/Keras-Cox-Model-master/keras_coxph_brca2019828_12fold6_one/Survival_leave_one_out_DeepSurv_onlyforpaper.png", width = 5.5, height = 5.5,
	units = "cm", res = 300, pointsize = 7)
plot(fit, mark.time=TRUE, xlab = "Months", ylab = "Survival", main=paste("Surival Curve with DeepSurv ",sep=""), lty = 1:2,
     col = 1:2, cex = 0.5)
grid()
