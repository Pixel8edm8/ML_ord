...
png(filename = "C:/IJCAI2020/code/deepSUR/Survival_10fold_DeepSurv_onlyforpaper.png", width = 5.5, height = 5.5,
	units = "cm", res = 300, pointsize = 7)
plot(fit, mark.time=TRUE, xlab = "Months", ylab = "Survival", main=paste("DeepSurv ",sep=""), lty = 1:2,
     col = 1:2, cex = 0.5)
grid()
