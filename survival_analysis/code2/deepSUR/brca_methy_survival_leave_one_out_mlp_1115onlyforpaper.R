...
png(filename = "E:/download/2019819Keras-Cox-Model-master/Keras-Cox-Model-master/keras_coxph_brca2019828_12fold6_one/Survival_leave_one_out_mlp1115.png", width = 5.5, height = 5.5,
	units = "cm", res = 300, pointsize = 7)
plot(fit, mark.time=TRUE, xlab = "Months", ylab = "Survival", main=paste("Surival Curve with MLP ",sep=""), lty = 1:2,
     col = 1:2, cex = 0.5)
grid()
