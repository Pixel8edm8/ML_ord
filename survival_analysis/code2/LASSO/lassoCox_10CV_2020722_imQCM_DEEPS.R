...
mydata= read.csv("brca_Surv_data_methylation_mRNA_all_lmqcm.csv",header = F, fill = F, stringsAsFactors=FALSE)
mydata = data.matrix(mydata)
mydata =mydata[2:486,]
s1 = nrow(mydata)
s2 = ncol(mydata)
mySurv = Surv(mydata[, 3], mydata[, 4]);
#x =cbind( mydata[, 5:137],mydata[, 15:40])
x = mydata[, 5:8]
...
png(filename = "C:/IJCAI2020/code/LASSO/lasso10_2020722_imQCM3_deep.png", width = 5.5, height = 5.5,
