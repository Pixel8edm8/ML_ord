...
# 
# mydata00= mydata0[-1,]
mydata0= mydata0[2:486,]
mydata1= mydata1[2:486,]
...
png(filename = "C:/2019821topc/2019917_rsf_brca/R_SRC/RSF_Survival_leave_one_out20200722_0.png", width = 5.5, height = 5.5,
