#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index=0.6458720847045357 ？ remove log_var[i] seems as no difference.
#only mRNA c-index=0.7222778652167692
#only methlytiion, cindex=0.5490055801974532
"""
...
#    np.savetxt("hist.history['loss1000_ml_ordCOX20201220']_without_penalty_term_only main loss.csv",hist.history['loss'], delimiter=",")
