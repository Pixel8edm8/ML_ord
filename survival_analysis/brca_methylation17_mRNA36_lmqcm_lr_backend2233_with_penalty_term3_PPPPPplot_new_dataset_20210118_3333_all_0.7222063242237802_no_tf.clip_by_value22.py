#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index= 0.7226355701817141 ？ remove log_var[i] seems as no difference.             
"""
...
#    plt.title('Lambda Curves with Penalty Term')
#    plt.ylabel('Train-lambda Value')
#    plt.xlabel('epoch')
#    plt.legend(['lambda1 for Main Task','lambda2 for Auxiliary Task'], loc='center right')
#    plt.savefig('Lambda Curves with Penalty Term.jpg', dpi=300) #指定分辨率保存
#    plt.show()
#    
#    plt.plot(range(EPOCH), std0,color='red')
#
#    plt.plot(range(EPOCH), std1,color='purple')
#    plt.title('Weight Curves with Penalty Term')
#    plt.ylabel('Train-weight Value')
#    plt.xlabel('epoch')
#    plt.legend(['Weight K1 for Main Task','Weight K2 for Auxiliary Task'], loc='center right')
#    plt.savefig('Weight Curves with penalty term.jpg', dpi=300) #指定分辨率保存
#    plt.show()
#    
#    plt.plot(range(EPOCH), hist.history['loss'])
#    plt.title('Training Loss Curves with Penalty Term')
#    plt.ylabel('train-loss Value')
#    plt.xlabel('epoch')
#
#    plt.savefig('Loss Curves with Penalty Term.jpg', dpi=300) #指定分辨率保存
#    plt.show()
#    
#    
#    np.savetxt("BRCA_methylation_mRNA_with_penalty_term_ml_ordCOX_20210106.csv",hist.history['loss'], delimiter=",")
#####################################################################################################################################    
#    import pylab
...
np.savetxt("BRCA_prediction1204_18lstm2222_epoch400_drop01_resnet_with penalty term.csv", ypred, delimiter=",")
np.savetxt("BRCA_ytime_test1204_18lstm2222_epoch400_drop01_resnet_with penalty term.csv", time_new, delimiter=",")
np.savetxt("BRCA_ystatus_test1204_18lstm2222_epoch400_drop01_resnet_with penalty term.csv", status_new, delimiter=",")
np.savetxt("BRCA_ypred_train_median1204_18lstm2222_epoch400_drop01_resnet_with penalty term.csv", ypred_train, delimiter=",")

df = pd.read_csv("BRCA_prediction1204_18lstm2222_epoch400_drop01_resnet_with penalty term.csv",header=None)    
month=np.asarray(pd.read_csv("BRCA_ytime_test1204_18lstm2222_epoch400_drop01_resnet_with penalty term.csv",header=None)) 
status=np.asarray(pd.read_csv("BRCA_ystatus_test1204_18lstm2222_epoch400_drop01_resnet_with penalty term.csv",header=None)) 
...
np.save("c_indices_with penalty term",c_indices_mlp)
print("BRCA_methylation17_mRNA36_lmqcm_lr_backend2233_with_penalty_term3_no_plot_new_dataset_20201230_3.py") 
print("BRCA:dataX=data_all_with_penalty:",c_indices_mlp)
data_a=np.load('c_indices_with penalty term.npy')
aa=0