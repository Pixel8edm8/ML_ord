...
#    print([np.exp(-K.get_value(log_var[0]))**0.5 for log_var in model.layers[-1].log_vars])
    ...
    predicted_main, predicted_aux = dense1_layer_model.predict([data_mRNA_test,data_methylation_test,y_test, ystatus2_test],verbose=1)
