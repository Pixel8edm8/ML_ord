...
#    plt.show() 
    ...
    plt.savefig('Lambda Curves without penalty term2.jpg', dpi=300) #指定分辨率保存
    plt.show()
...
#    plt.legend(['${lambda0}$','${lambda1}$'], loc='upper right')
    plt.savefig('Loss Curves without penalty term2.jpg', dpi=300) #指定分辨率保存
    plt.show()
    
    
    np.savetxt("BRCA_methylation_mRNA_without_penalty_term_ml_ordCOX_20210106_mRNA.csv",hist.history['loss'], delimiter=",")
