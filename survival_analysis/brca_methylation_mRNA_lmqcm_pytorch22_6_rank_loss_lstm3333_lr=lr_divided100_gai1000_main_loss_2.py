#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000,lr=0.0005 lr/200 c_index=0.673486907998283  无lamda1*lamda2
"""
...
#    params = ([p for p in model2.parameters()] + [log_var_a] + [log_var_b])
    ...
    learning_rate=0.001
    lr2=[0.0005,0.0005,0.0004,0.0002,0.0001,0.00005,0.00004,0.00002,0.00001,0.000005,0.000002]
...
#    plt.show() 
    ...
    np.savetxt("hist.history['loss2000_M_m_only_main'].csv",loss_history, delimiter=",")
    # Pred
