#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index=0.6385033624266705 ？ remove log_var[i] seems as no difference.
...
#    np.savetxt("brca_methylation_mRNA_without_penalty_term_only main loss20201223.csv",hist.history['loss'], delimiter=",")
    np.savetxt("brca_only_mRNA_without_penalty_term_only main loss20201223.csv",hist.history['loss'], delimiter=",")
#    np.savetxt("brca_only_methylation_without_penalty_term_only main loss20201223.csv",hist.history['loss'], delimiter=",")
...
print("mRNA+methylation_main_loss:",c_indices_mlp)
