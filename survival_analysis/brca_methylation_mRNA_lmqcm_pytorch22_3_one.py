...
class Net(nn.Module):
    def __init__(self, input_size, hidden_size, output1_size):
        ...
        self.lstm = nn.LSTM(input_size=input_size, hidden_size=hidden_size,bidirectional=True)  #dropout=0.1, num_layers=2,
        #self.fc1 = nn.Linear(input_size, hidden_size) 
        #self.relu = nn.ReLU()
        self.fc2 = nn.Linear(hidden_size*2, output1_size)
