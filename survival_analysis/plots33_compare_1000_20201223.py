...
loss500_ordCOX1 = np.asarray(pd.read_csv("hist.history['loss1000_ml_ordCOX20201220']_without_penalty_term.csv",header=None))  
...
plt.savefig('Loss Curves2_12.jpg', dpi=300) #指定分辨率保存
plt.show()
