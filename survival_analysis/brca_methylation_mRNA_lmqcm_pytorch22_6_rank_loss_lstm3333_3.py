#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index=0.6479467735012162    remove log_var[i] seems as no difference.
"""
...
#        self.fc3 = nn.Linear(hidden_size*2, output2_size)
        self.fc2 = nn.Linear(20, output1_size)
        self.fc3 = nn.Linear(20, output2_size)
...
#    plt.show() 
    ...
    prediction =1*predicted_main+1*predicted_aux
