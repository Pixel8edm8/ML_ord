#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index=0.6875804836171127 remove log_var[i] seems as no difference.
"""
...
class Net(nn.Module):
    def __init__(self, input_size, hidden_size, output1_size, output2_size):
        ...
        self.lstm = nn.LSTM(input_size=input_size, hidden_size=hidden_size,num_layers=2,batch_first=True)#, bidirectional=True)#batch_first=True,
#        self.lstm = nn.LSTM(input_size=input_size, hidden_size=hidden_size,num_layers=2,batch_first=True)   
        self.fc1 = nn.Linear(hidden_size, 50) 
        self.relu = nn.ReLU()
        self.fc11 = nn.Linear(50, 20)
