...
class Net(nn.Module):
    def __init__(self, input_size, hidden_size, output1_size, output2_size):
        ...
        #self.relu = nn.ReLU()
        self.fc2 = nn.Linear(hidden_size*2, 20)
        self.fc21=nn.Dropout(p=0.1)
        self.fc22 = nn.Linear(20, output1_size)
        
        self.fc3 = nn.Linear(hidden_size*2, 20)
        self.fc31=nn.Dropout(p=0.1)
        self.fc33 = nn.Linear(20, output2_size)
    ...
    def forward(self, x):
        ...
        #out = self.relu(out00)
        out01 = self.fc2(out)
        out011=self.fc21(out01)
        out1 = self.fc22(out011)
        
        out02 = self.fc3(out)
        out021=self.fc31(out02)
        out2 = self.fc33(out021)
        return out1, out2
