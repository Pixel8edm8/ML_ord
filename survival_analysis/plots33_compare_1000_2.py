...
loss500_M_m = np.asarray(pd.read_csv("hist.history['loss2000_M_m']_former.csv",header=None))
...
plt.plot(epoch,loss500_ordCOX1[0:1000])
plt.plot(epoch,loss500_M_m[0:1000] )
#plt.plot(epoch,loss500_Methylation )
#plt.plot(epoch,loss500_mRNA )
plt.title('Loss Curves')
plt.ylabel('train-loss')
plt.xlabel('epoch')
plt.legend(['ML_ordCOX','${G_mRNA-meth}$'], loc='upper right')
