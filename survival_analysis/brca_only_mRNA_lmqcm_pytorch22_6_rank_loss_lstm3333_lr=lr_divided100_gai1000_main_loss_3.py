#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000,lr=0.0005 lr/200 c_index=0.5872656664710977   无lamda1*lamda2
"""
...
##############################
# load dataset
kidtx = pd.read_csv('eigengene_matrix_mRNAseq_RPKM_minClusterSize10.csv')
x =kidtx.drop(["Unnamed: 0","V1","erged_data33"], axis = 1).values
...
#    plt.show() 
    ...
    np.savetxt("hist.history['loss1000_mRNA'].csv", loss_history, delimiter=",")
    # Pred
