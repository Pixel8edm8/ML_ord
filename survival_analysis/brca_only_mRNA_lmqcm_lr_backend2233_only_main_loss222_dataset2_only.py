#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index=0.7003147803691515 ？ remove log_var[i] seems as no difference.
#only mRNA c-index=0.7227071111747031
#only methlytiion, cindex=0.49
"""
...
dataX1 =kidtx.drop(["Unnamed: 0","V1","erged_data33"], axis = 1).values
y = np.transpose(np.array((kidtx["V1"], kidtx["erged_data33"]))) # V1=time; erged_data33=status
