#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, all_data:c_index=0.6970238946916584                 (0.72664 )？ remove log_var[i] seems as no difference.
#brca:dataX=data_mRNA:",c_index=brca:dataX=data_only_mRNA: 0.665331234797539
#brca:dataX=data_methylation:",c_index=brca:dataX=data_methylation: 0.4493489769638003
"""
...
data_methylation=dataX[:,0:17]
data_mRNA=dataX[:,17:n0]
...
#    [ m01,n01] = x_train.shape
#    [ m02,n02] = x_test.shape
#                      
#    x_train =minmax_scale(x_train ) 
#    x_test =minmax_scale(x_test )
#    x_train = x_train.reshape(m01,1,n01)
#    x_test = x_test.reshape(m02,1,n02)
...
#    
#    
#    np.savetxt("hist.history['loss1000_ml_ordCOX20201220']_without_penalty_term.csv",hist.history['loss'], delimiter=",")
...
#    prediction =l12[0]*predicted_main+l12[1]*predicted_aux
    prediction =1*predicted_main+1*predicted_aux  #0.5:0.6977393046215481; 1:?
...
print("brca:dataX=data_only_mRNA:",c_indices_mlp)
