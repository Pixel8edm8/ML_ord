...
#    plt.legend(['${lambda0}$','${lambda1}$'], loc='upper right')
    ...
    np.savetxt("hist.history['loss1000_ml_ordCOX20201220']_with_penalty_term.csv",hist.history['loss'], delimiter=",")
...
np.save("c_indices_with penalty term.npy",c_indices_mlp) 
print(c_indices_mlp)
data_a=np.load('c_indices_with penalty term.npy.npy')
aa=0