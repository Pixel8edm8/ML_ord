#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index=0.698168550579482 ？ remove log_var[i] seems as no difference.
"""
...
kidtx = pd.read_csv('brca_Surv_data_methylation_2times_mRNA_minClusterSize10_all_lmqcm20201223_0.csv')
...
data_methylation=dataX1[:,0:33]
data_mRNA=dataX1[:,33:n0]
#dataX=data_mRNA
[ m,n] = dataX.shape
