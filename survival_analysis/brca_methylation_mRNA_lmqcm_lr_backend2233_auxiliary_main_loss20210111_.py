#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#only main_loss,epochs =1000, c_index=0.7047503219344684 ？ remove log_var[i] seems as no difference.
#only auxiliary_loss,epochs =1000, c_index= 0.4950636714837602
"""
...
#    plt.legend(['${lambda0}$','${lambda1}$'], loc='upper right')
    plt.savefig('Loss Curves only auxiliary loss.jpg', dpi=300) #指定分辨率保存
    plt.show()
...
print("brca_methylation_mRNA_lmqcm_lr_backend2233_auxiliary_main_loss20210111_.py") 
