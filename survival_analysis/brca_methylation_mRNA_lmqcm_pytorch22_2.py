...
class Net(nn.Module):
    def __init__(self, input_size, hidden_size, output1_size, output2_size):
        ...
        self.lstm = nn.LSTM(input_size=input_size, hidden_size=hidden_size,dropout=0.1, num_layers=2,bidirectional=True)
...
############# convert data into torch from numpy array
    ...
    # Pred
    inp_test0 = torch.from_numpy(x_test)
    
    inp_test = Variable(inp_test0).type(torch.FloatTensor)
