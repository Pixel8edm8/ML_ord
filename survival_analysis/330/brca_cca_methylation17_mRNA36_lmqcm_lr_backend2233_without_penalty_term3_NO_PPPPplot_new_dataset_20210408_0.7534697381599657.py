#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000, c_index= 0.7534697381599657 ？ remove log_var[i] seems as no difference.  0.7534697381599657
...
kidtx = np.array(pd.read_csv('BRCA_data_mm_dscca.csv',header=None))#不把第一行作列属性)
