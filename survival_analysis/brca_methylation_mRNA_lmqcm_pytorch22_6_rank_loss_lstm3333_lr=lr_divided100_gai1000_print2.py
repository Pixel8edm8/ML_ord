#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#NO RISK,epochs =1000,lr=0.0005 c_index= 无lamda1*lamda2
"""
...
#                new_tensor = matrix_risk+risk_j * one_hot_j
        ...
        #        tf.reduce_sum(tf.one_hot(sum(H[13:],[]),n1,dtype=tf.float32),axis=0)
        matrix_risk= matrix_risk+ matrix_j 
    cost2 = -torch.sum(matrix_risk)/20#/(len(Hj))
#    print("cost2:",cost2)
    return cost2 
...
np.savetxt("brca_prediction1204_18lstm2222_epoch400_drop01_ord.csv", ypred, delimiter=",")
np.savetxt("brca_ytime_test1204_18lstm2222_epoch400_drop01_ord.csv", time_new, delimiter=",")
np.savetxt("brca_ystatus_test1204_18lstm2222_epoch400_drop01_ord.csv", status_new, delimiter=",")
np.savetxt("brca_ypred_train_median1204_18lstm2222_epoch400_drop01_ord.csv", ypred_train, delimiter=",")

df = pd.read_csv("brca_prediction1204_18lstm2222_epoch400_drop01_ord.csv",header=None)    
month=np.asarray(pd.read_csv("brca_ytime_test1204_18lstm2222_epoch400_drop01_ord.csv",header=None)) 
status=np.asarray(pd.read_csv("brca_ystatus_test1204_18lstm2222_epoch400_drop01_ord.csv",header=None)) 
